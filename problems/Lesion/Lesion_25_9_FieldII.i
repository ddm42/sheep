###############################################################################
# Lesion_25_9_FieldII.i  -- Lesion_25_9 with Field II ARF spatial profile
#
...
#
# Materials: mu_B = 25 kPa (c_s_B = 5 m/s), mu_L = 9 kPa (c_s_L = 3 m/s).
# Soft lesion (slower than background).
#
...
end_time   = 30e-3                      # max observation window before x-boundary reflections enter imaging domain at ~25 ms (4_9 is the binding case; matched here for consistency)

# Output filename
filename = 'Lesion_25_9_FieldII_h0.25mm'
suffix   = ''

# Data directory
data_dir   = '/Users/ddm42/Google Drive/My Drive/1_Work-Duke-Research/Artery_Research/data/artery_OED'
output_dir = '${data_dir}/Lesion_25_9_FieldII/exodus'
