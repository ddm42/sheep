#!/bin/bash
###############################################################################
# run_soft_dt_convergence.sh -- Timestep convergence study for Lesion-Soft-ARFCenter
#
...
#
# Usage:
#   ./run_soft_dt_convergence.sh            # run all dt levels
#   ./run_soft_dt_convergence.sh 2          # run only level 2
###############################################################################
...
echo "================================================="
echo "Lesion-Soft Timestep Convergence Study"
echo "================================================="
...
# Allow running a single level: ./run_soft_dt_convergence.sh <level>
if [ -n "$1" ]; then
    START=$1; END=$1
else
